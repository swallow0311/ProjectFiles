          ...
          <Table className="min-w-[2200px] border-separate border-spacing-0">
            <TableHeader className="bg-slate-50">
              <TableRow className="hover:bg-transparent">
                ...
                <TableHead rowSpan={2} className="sticky right-0 bg-slate-50 z-50 shadow-[-4px_0_10px_rgba(0,0,0,0.08)] text-center font-bold py-2 border-b border-l w-40">操作</TableHead>
              </TableRow>
              <TableRow className="hover:bg-transparent">
            ...
            <TableBody>
              {data.map((item) => (
                <TableRow key={item.id} className="group">
                  ...
                  <TableCell className="sticky right-0 bg-white z-40 shadow-[-4px_0_10px_rgba(0,0,0,0.08)] group-hover:bg-slate-50 transition-colors border-l">
