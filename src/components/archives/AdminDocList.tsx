        ...
        <ScrollArea className="w-full">
          <Table className="min-w-[1200px] border-separate border-spacing-0">
            <TableHeader className="bg-slate-50">
              <TableRow>
                <TableHead className="border-b">文件标题</TableHead>
                <TableHead className="border-b">文件类型</TableHead>
                <TableHead className="border-b">文号</TableHead>
                <TableHead className="border-b">发文单位</TableHead>
