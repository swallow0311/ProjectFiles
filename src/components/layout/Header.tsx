...
import { Library, User, Bell, Settings, Sparkles } from 'lucide-react';
    ...
    <header className="h-16 border-b border-white/5 bg-[#020617] text-white flex items-center px-6 shrink-0 z-50 shadow-2xl">
      ...
      <div className="ml-auto flex items-center gap-5">
        <div className="flex items-center gap-2 bg-white/5 p-1 rounded-full border border-white/10">
          <button className="p-2 text-slate-400 hover:text-white transition-all rounded-full hover:bg-white/10">
            <Bell size={16} />
          </button>
          <button className="p-2 text-slate-400 hover:text-white transition-all rounded-full hover:bg-white/10">
            <Settings size={16} />
